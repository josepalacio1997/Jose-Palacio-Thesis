// ============================================================================
// rsv_renewal_ar2.stan
//
// MARSS-hybrid AR(2) — rho FIJO (data, no parametro).
// Diferencia vs rsv_renewal_rhoest_ar2.stan:
...
// Compatible con MARSS Stage 1 (use_filter=1, sigma_obs como data P x T).
//
// Para rho=0, pasar rho=0.0. Para sweep AR(2), pasar el rho que toque.
// ============================================================================
...
model {
  log_beta ~ normal(0, 4);
  sigma_obs_pl ~ normal(0, 2);  // half-Normal(0, 2^2) via <lower=0>; matches renewal_A_fsv_ar2.stan. Only active when use_filter==0.
