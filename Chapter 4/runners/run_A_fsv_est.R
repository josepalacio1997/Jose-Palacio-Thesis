...
# Llamada: Rscript run_A_fsv_est.R [ALPHA_RHO] [BETA_RHO] [WARMUP] [SAMPLING]
#   ej. Rscript run_A_fsv_est.R                  # defaults: Beta(2,2)
#   ej. Rscript run_A_fsv_est.R 2 2 4000 6000    # explicit
#   ej. Rscript run_A_fsv_est.R 1 1              # Uniform(0,1)
#
# Stan: stan/renewal_A_fsv_est.stan
# Output: outputs/stan_fits_fsv_rhoest/rho_estimated.rds
# ============================================================================
