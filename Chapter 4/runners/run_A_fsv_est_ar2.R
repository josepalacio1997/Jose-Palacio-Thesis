...
# run_A_fsv_est_ar2.R
#
# In-sample fit del modelo FSV con RHO ESTIMADO Y second-order.
...
# Llamada: Rscript run_A_fsv_est_ar2.R [ALPHA_RHO] [BETA_RHO] [WARMUP] [SAMPLING]
#   ej. Rscript run_A_fsv_est_ar2.R               # defaults: Beta(2,2)
#   ej. Rscript run_A_fsv_est_ar2.R 2 2 2000 8000
#
# Stan: stan/renewal_A_fsv_est_ar2.stan
# Output: outputs/stan_fits_fsv_rhoest_ar2/rho_estimated.rds
# ============================================================================
...
cat(sprintf("\n=== IN-SAMPLE FSV second-order (rho ESTIMATED, Beta(%g, %g)) ===\n",
            ALPHA_RHO, BETA_RHO))
...
save_object <- list(
  ...
  model_variant = "freesigma_vec_rhoest_ar2",
  draws = draws_arr,
...
#   1. gc() para liberar fit MCMC antes del write
