# ============================================================================
# run_A_marss_est_HD.R
#
# HAUSDORFF ABLATION variant of run_A_marss_est.R
# -----------------------------------------------------------------------------
...
# Llamada: Rscript run_A_marss_est_HD.R [ALPHA_RHO] [BETA_RHO] [WARMUP] [SAMPLING]
#   ej. Rscript run_A_marss_est_HD.R                  # defaults: Beta(2,2)
#
# Stan:   stan/renewal_A_marss_est.stan          (unchanged)
# Output: outputs/stan_fits_marss_rhoest_HD/rho_estimated.rds
# ============================================================================
...
fits_dir <- file.path(proj_root, "outputs", "stan_fits_marss_rhoest_HD")
