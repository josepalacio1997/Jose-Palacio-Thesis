# ============================================================================
# run_A_fsv_est_eucl.R
#
# EUCLIDEAN ABLATION variant of run_A_fsv_est.R
# -----------------------------------------------------------------------------
...
# Llamada: Rscript run_A_fsv_est_eucl.R [ALPHA_RHO] [BETA_RHO] [WARMUP] [SAMPLING]
#   ej. Rscript run_A_fsv_est_eucl.R                  # defaults: Beta(2,2)
#   ej. Rscript run_A_fsv_est_eucl.R 2 2 4000 6000    # explicit
#
# Stan:   stan/renewal_A_fsv_est.stan       (unchanged)
# Output: outputs/stan_fits_fsv_rhoest_eucl/rho_estimated.rds
# ============================================================================
...
fits_dir <- file.path(proj_root, "outputs", "stan_fits_fsv_rhoest_eucl")
